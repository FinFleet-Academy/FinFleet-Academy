        ...
        <div className="mb-16 text-center md:text-left relative">
           ...
           <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div className="max-w-2xl">
                 <motion.h1 {...fadeInUp} transition={{ delay: 0.1 }} className="text-4xl md:text-6xl font-black dark:text-white tracking-tighter mb-6">Financial <span className="text-brand-600">Hub</span></motion.h1>
