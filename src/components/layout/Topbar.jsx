    ...
    <header className="h-20 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 px-4 sm:px-8 flex items-center justify-between z-[80] transition-colors duration-500">
      ...
      <div className="flex items-center space-x-4">
        <button 
          ...
          className="p-2 text-slate-400 hover:text-indigo-600 lg:hidden"
        >
      ...
      <div className="flex items-center space-x-2 sm:space-x-4">
        ...
        <button 
          onClick={toggleTheme}
          className="p-3 text-slate-400 hover:text-indigo-600 transition-colors rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800"
        >
          {isDarkMode ? <Sun className="w-5 h-5" /> : <Moon className="w-5 h-5" />}
        </button>

        {/* Notifications */}
        <button className="p-3 text-slate-400 hover:text-indigo-600 relative rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800">
        ...
        <div className="flex items-center space-x-3 pl-2 group cursor-pointer">
          ...
          <div className="w-10 h-10 rounded-2xl bg-indigo-600 flex items-center justify-center text-white font-black shadow-lg shadow-indigo-500/20 group-hover:scale-105 transition-transform">
